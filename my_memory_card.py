...
questions_list = []
questions_list.append(Question('RED SUS?' , 'YES' , 'DONt' , 'NOT' , 'NO'))
questions_list.append(Question('YOU ABEME?' , 'YES' , 'DONt' , 'NOT' , 'NO'))
questions_list.append(Question('YOU LIKE SHREK?', 'YES' , 'DONt' , 'NOT' , 'NO'))
...
def check_answer():
    if answers[0].isChecked():
        show_correct('MOLODEC')
        window.score += 1
        print('Рейтинг:' , (window.score/window.total*100), '%')
    else:
        if answers[1].isChecked or answers[2].isChecked or answers[3].isChecked:
            show_correct('YOU ARE A IMPOSTR')
            print('Рейтинг:' , (window.score/window.total*100), '%')
